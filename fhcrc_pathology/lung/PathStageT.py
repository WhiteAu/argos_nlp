...
def get(disease_group,dictionary,specimen,module_sections):
    ...
    '''
    return_dictionary={global_strings.NAME:"PathStageT",global_strings.VALUE:None,global_strings.KEY:specimen,global_strings.CONFIDENCE:0.0,global_strings.VERSION:__version__,
